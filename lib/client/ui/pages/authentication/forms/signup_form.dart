  ...
  Widget build(BuildContext context) {
    ...
    return Column(
        ...
        children: <Widget>[
          ...
          _buildTF('Nombre de Usuario', TextInputType.name, false, width,
              height, textControllers[1]),
          SizedBox(height: (15.0 / 756) * height),
          _buildTF('Correo Electrónico', TextInputType.emailAddress, false,
              width, height, textControllers[2]),
          SizedBox(height: (15.0 / 756) * height),
          _buildTF('Contraseña', TextInputType.visiblePassword, _isObscure,
              width, height, textControllers[3]),
          SizedBox(height: (15.0 / 756) * height),
          _buildTF('Confirmar Contraseña', TextInputType.visiblePassword,
              _isObscure, width, height, textControllers[4]),
